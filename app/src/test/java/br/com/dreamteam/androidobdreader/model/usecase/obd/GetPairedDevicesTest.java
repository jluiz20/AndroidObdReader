...
/**
 * Tests for {@link GetPairedDevices}
 *
 * @author João Luiz Vieira <vieira.jluiz@gmail.com>.
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest(Log.class)
public class GetPairedDevicesTest {
    ...
    public void test_execute() throws Exception {
        when(obdRepository.getPairedDevices()).thenReturn(bluetoothDevices);

        getPairedDevices.execute(caseCallback);
    ...
    public void test_execute_error() throws Exception {
        ...
        doThrow(runtimeException).when(obdRepository).getPairedDevices();
